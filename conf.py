...
html_theme_options = {
    ...
    'navbar_title': "Uputstvo za Zimsku Školu otvorenih podataka",

    # Tab name for entire site. (Default: "Site")
    'navbar_site_name': "Uputstvo",
...
html_title = 'Uputstvo za zimsku školu otvorenih podataka'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Uputstvo'
